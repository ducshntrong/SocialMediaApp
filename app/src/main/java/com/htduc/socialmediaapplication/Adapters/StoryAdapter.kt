...
import com.htduc.socialmediaapplication.databinding.StoryRvDesignBinding
...
class StoryAdapter(private val context: Context, private var listStory: ArrayList<Story>)
    ...
    inner class StoryViewHolder(binding: StoryRvDesignBinding): RecyclerView.ViewHolder(binding.root) {
        ...
        val storyType = binding.storyType
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StoryViewHolder {
        return StoryViewHolder(StoryRvDesignBinding.inflate(LayoutInflater.from(parent.context)
            , parent, false))
    }
