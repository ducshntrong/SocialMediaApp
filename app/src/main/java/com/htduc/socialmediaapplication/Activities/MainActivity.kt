...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val (label, confidence) = textClassifier.predict("thằng lol này ngáo à")
        Toast.makeText(this, "RESULT Label: $label - Confidence: ${"%.2f".format(confidence * 100)}%", Toast.LENGTH_SHORT).show()
